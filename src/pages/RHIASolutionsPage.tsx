...
import { Brain, CheckCircle, ArrowRight, Users, TrendingUp, Lightbulb, BarChart3 } from 'lucide-react'
      ...
      >
        <div className="w-4/5 mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                title: 'Recrutement par IA',
                description: 'Tri automatique de CV, scoring de candidats, prédiction d\'adéquation culturelle et compétences.',
                icon: Users
              },
              {
                title: 'Analyse de Talents',
                description: 'Identification des hauts potentiels, mapping de compétences, planification de succession.'
              },
              {
                title: 'Gestion Talentuelle',
                description: 'Plans de développement personnalisés, recommandations de mobilité, égalité des genres.',
                icon: TrendingUp
              },
              {
                title: 'Prédictions RH',
                description: 'Prédiction de turnover, identification des risques, recommandations de rétention.',
                icon: Lightbulb
              },
              {
                title: 'Paie Intelligente',
                description: 'Automatisation de la paie, benchmarking salarial, équité de rémunération.',
                icon: BarChart3
              },
              {
                title: 'Engagement Employés',
                description: 'Surveys intelligentes, analyse du sentiment, recommandations d\'amélioration.'
              }
            ].map((item, i) => {
      ...
      >
        <div className="w-4/5 mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-4xl mx-auto">
            {[
              'Réduction du temps de recrutement de 70%',
        ...
        <div className="w-4/5 mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              {
                title: 'Tech & Startups',
                desc: 'Recrutement rapide de talents tech, gestion d\'équipes distribuées.'
              },
              {
                title: 'Grandes Entreprises',
                desc: 'Transformation RH, conformité RGPD, équité salariale.'
              },
              {
                title: 'Retail & E-commerce',
                desc: 'Gestion des saisonniers, prédiction des pics d\'activité.'
              },
              {
                title: 'Santé & Pharma',
                desc: 'Gestion des talents spécialisés, conformité réglementaire.'
              }
            ].map((useCase, i) => (
              <motion.div
                key={i}
